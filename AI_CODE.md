# AI_CODE — GenBI 核心源碼快照

> 配合 `AI_CONTEXT.md` 使用 — 本檔僅放完整檔案內容,設計概念、API、deployment 流程都在 AI_CONTEXT.md。

# 📌 用途

- 給 LLM agent / 接手開發者直接看完整實作(不必 navigate repo)
- v0.2.x 版本快照 — v0.3.0 新檔案(repositories / migrations / admin / pages)未 embed,請到 repo 對應路徑
- AI_CONTEXT.md section 17 / 18 含 v0.3.0 Repository API 的完整簽名,通常理解使用方式只看 AI_CONTEXT.md 即可
...
- 15.2 · `.env.example`
- 15.3 · `config.py`
- 15.4 · `llm_service.py`(完整版,v0.2.x f-string 形式)
- 15.5 · `app.py`(完整版,v0.2.x 形式)
